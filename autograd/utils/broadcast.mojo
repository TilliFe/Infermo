...
fn recursive_broadcast[kernel: fn(c: Node, a: Node, b: Node, a_index: Int, b_index: Int, c_index: Int, depth: Int ) -> None, base_case: fn(depth: Int, a: Node, b: Node) -> Bool](
    c: Node, 
    a: Node, 
    b: Node, 
    a_index: Int=0, 
...
# recursive broadcast
fn recursive_broadcast_bw[kernel: fn(c: Node, a: Node, b: Node, a_index: Int, b_index: Int, c_index: Int, depth: Int ) -> None, base_case: fn(depth: Int, a: Node, b: Node) -> Bool](
    c: Node, 
    a: Node, 
    b: Node, 
    a_index: Int=0, 
