...
struct Tensor:
    ...
    fn __init__(inout self, shape: DynamicVector[Int], is_static: Bool = True, is_single: Bool = False, init_graph: Bool = True, init_node: Bool = True) raises:
    ...
    fn __init__(inout self, shape: Vector[Int], is_static: Bool = True, is_single: Bool = False, init_graph: Bool = True, init_node: Bool = True) raises:
    ...
    fn load_tensor_for_binary_op(self, other: Tensor) raises -> Tensor:
        ...
        if ((self.node_ptr.load().load().is_static_ptr.load() or self.node_ptr.load().load().is_single_ptr.load())
          and other.node_ptr.load().load().is_static_ptr.load() or other.node_ptr.load().load().is_single_ptr.load()):
            new_tensor = Tensor(self.node_ptr.load().load().shape_ptr.load().copy(),False,False,True,False)
            ...
            new_tensor = Tensor(self.node_ptr.load().load().shape_ptr.load().copy(),False,False,False,False)
            ...
            # the left parent is dynamic and the right is static -> use the left graph
            elif other.node_ptr.load().load().is_static_ptr.load() or other.node_ptr.load().load().is_single_ptr.load():
                ...
                if(self.graph_ptr.load().load().nodes.load().len.load() >= other.graph_ptr.load().load().nodes.load().len.load()):
                    new_tensor.graph_ptr.store(self.graph_ptr.load())
    ...
    fn backward(self) raises:
        self.graph_ptr.load().load().backward(
            self.node_ptr.load()
        )
    ...
    fn sin(self) raises -> Tensor:
        ...
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().sin(
            self.node_ptr.load())
        )        
        return new_tensor
    ...
    fn cos(self) raises -> Tensor:
        let new_tensor = self.load_tensor_for_unary_op()
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().cos(
            self.node_ptr.load())
        )        
        return new_tensor
    ...
    fn tan(self) raises -> Tensor:
        let new_tensor = self.load_tensor_for_unary_op()
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().tan(
            self.node_ptr.load())
        )        
        return new_tensor
    ...
    fn acos(self) raises -> Tensor:
        let new_tensor = self.load_tensor_for_unary_op()
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().acos(
            self.node_ptr.load())
        )        
        return new_tensor
    ...
    fn asin(self) raises -> Tensor:
        let new_tensor = self.load_tensor_for_unary_op()
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().asin(
            self.node_ptr.load())
        )        
        return new_tensor
    ...
    fn atan(self) raises -> Tensor:
        let new_tensor = self.load_tensor_for_unary_op()
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().atan(
            self.node_ptr.load())
        )        
        return new_tensor
    ...
    fn cosh(self) raises -> Tensor:
        let new_tensor = self.load_tensor_for_unary_op()
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().cosh(
            self.node_ptr.load())
        )        
        return new_tensor
    ...
    fn sinh(self) raises -> Tensor:
        let new_tensor = self.load_tensor_for_unary_op()
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().sinh(
            self.node_ptr.load())
        )        
        return new_tensor
    ...
    fn tanh(self) raises -> Tensor:
        let new_tensor = self.load_tensor_for_unary_op()
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().tanh(
            self.node_ptr.load())
        )        
        return new_tensor
    ...
    fn log(self) raises -> Tensor:
        let new_tensor = self.load_tensor_for_unary_op()
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().log(
            self.node_ptr.load())
        )        
        return new_tensor
    ...
    fn log2(self) raises -> Tensor:
        let new_tensor = self.load_tensor_for_unary_op()
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().log2(
            self.node_ptr.load())
        )        
        return new_tensor
    ...
    fn exp(self) raises -> Tensor:
        let new_tensor = self.load_tensor_for_unary_op()
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().exp(
            self.node_ptr.load())
        )        
        return new_tensor
    ...
    fn exp2(self) raises -> Tensor:
        let new_tensor = self.load_tensor_for_unary_op()
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().exp2(
            self.node_ptr.load())
        )        
        return new_tensor
    ...
    fn sqrt(self) raises -> Tensor:
        let new_tensor = self.load_tensor_for_unary_op()
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().sqrt(
            self.node_ptr.load())
        )        
        return new_tensor
    ...
    fn abs(self) raises -> Tensor:
        let new_tensor = self.load_tensor_for_unary_op()
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().abs(
            self.node_ptr.load())
        )        
        return new_tensor
    ...
    fn relu(self) raises -> Tensor:
        let new_tensor = self.load_tensor_for_unary_op()
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().relu(
            self.node_ptr.load())
        )        
        return new_tensor
    ...
    fn copy(self) raises -> Tensor:
        let new_tensor = self.load_tensor_for_unary_op()
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().copy(
            self.node_ptr.load())
        )        
        return new_tensor
    ...
    fn __add__(self, other: Tensor) raises -> Tensor:
        ...
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().add(
    ...
    fn __sub__(self, other: Tensor) raises -> Tensor:
        let new_tensor = self.load_tensor_for_binary_op(other)
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().sub(
            self.node_ptr.load(),other.node_ptr.load())
        )    
        return new_tensor
    ...
    fn __mul__(self, other: Tensor) raises -> Tensor:
        let new_tensor = self.load_tensor_for_binary_op(other)
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().mul(
            self.node_ptr.load(),other.node_ptr.load())
        )    
        return new_tensor
    ...
    fn __truediv__(self, other: Tensor) raises -> Tensor:
        let new_tensor = self.load_tensor_for_binary_op(other)
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().div(
            self.node_ptr.load(),other.node_ptr.load())
        )    
        return new_tensor
    ...
    fn __pow__(self, other: Tensor) raises -> Tensor:
        let new_tensor = self.load_tensor_for_binary_op(other)
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().pow(
            self.node_ptr.load(),other.node_ptr.load())
        )    
        return new_tensor
    ...
    fn __matmul__(self, other: Tensor) raises -> Tensor:
        let new_tensor = self.load_tensor_for_binary_op(other)
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().mmul(
            self.node_ptr.load(),other.node_ptr.load())
        )    
        return new_tensor
    ...
    fn __iadd__(self, other: Tensor) raises:
        self.node_ptr.store(self.graph_ptr.load().load().add(
            self.node_ptr.load(),other.node_ptr.load())
        )
    
    fn __isub__(self, other: Tensor) raises:
        self.node_ptr.store(self.graph_ptr.load().load().sub(
            self.node_ptr.load(),other.node_ptr.load())
        )

    fn __imul__(self, other: Tensor) raises:
        self.node_ptr.store(self.graph_ptr.load().load().mul(
            self.node_ptr.load(),other.node_ptr.load())
        )
    
    fn __itruediv__(self, other: Tensor) raises:
        self.node_ptr.store(self.graph_ptr.load().load().div(
            self.node_ptr.load(),other.node_ptr.load())
        )
    
    fn __ipow__(self, other: Tensor) raises:
        self.node_ptr.store(self.graph_ptr.load().load().pow(
            self.node_ptr.load(),other.node_ptr.load())
        )
    
    fn __imatmul__(self, other: Tensor) raises:
        self.node_ptr.store(self.graph_ptr.load().load().mmul(
            self.node_ptr.load(),other.node_ptr.load())
        )

    fn __add__(self, number: Float32) raises -> Tensor:
        let other = Tensor(self.node_ptr.load().load().shape_ptr.load().copy(),False,True,True,True).fill(number)
    ...
    fn __rpow__(self, number: Float32) raises -> Tensor:
        let other = Tensor(self.node_ptr.load().load().shape_ptr.load().copy(),False,False,True,True).fill(number)
    ...
    fn reshape(self, shape: Vector[Int]) raises -> Tensor:
        let new_tensor = self.load_tensor_for_unary_op()
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().reshape(
            self.node_ptr.load(),shape)
        )        
        return new_tensor

    fn transpose(self) raises -> Tensor:
        let new_tensor = self.load_tensor_for_unary_op()
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().transpose(
            self.node_ptr.load())
        )        
        return new_tensor
    ...
    fn sum(self, axis: Int = -1) raises -> Tensor:
        let new_tensor = self.load_tensor_for_unary_op()
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().sum(
            self.node_ptr.load(),axis)
        )        
        return new_tensor

    fn mse(self, other: Tensor) raises -> Tensor:
        let new_tensor = self.load_tensor_for_binary_op(other)
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().mse(
            self.node_ptr.load(),other.node_ptr.load())
        )    
        return new_tensor
    ...
    fn cross_entropy(self, other: Tensor) raises -> Tensor:
        let new_tensor = self.load_tensor_for_binary_op(other)
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().ce(
            other.node_ptr.load(),self.node_ptr.load())
        )    
        return new_tensor

    fn softmax(self, axis: Int = -1) raises -> Tensor:
        let new_tensor = self.load_tensor_for_unary_op()
        new_tensor.node_ptr.store(new_tensor.graph_ptr.load().load().softmax(
            self.node_ptr.load(),axis)
        )        
        return new_tensor
...
fn fuse_graphs(graph_ptr: Pointer[Pointer[Graph]], other_graph_ptr: Pointer[Pointer[Graph]], remove_other: Bool = False) raises: 
    ...
    for i in range(other_graph_ptr.load().load().nodes.load().len.load()):
        ...
        for j in range(node_ptr.load().children_ptr.load().len.load()):
            node_ptr.load().children_ptr.load().store(j, node_ptr.load().children_ptr.load().load(j) + num_nodes)
        for j in range(node_ptr.load().parents_ptr.load().len.load()):
            node_ptr.load().parents_ptr.load().store(j, node_ptr.load().parents_ptr.load().load(j) + num_nodes)
    ...
    for i in range(other_graph_ptr.load().load().memory_pool.load().len.load()):
        graph_ptr.load().load().memory_pool.load().push_back(other_graph_ptr.load().load().memory_pool.load().load(i))

    # memory_pool manager
    for i in range(30):
        for j in range(other_graph_ptr.load().load().memory_pool_manager.load(i).len.load()):
            graph_ptr.load().load().memory_pool_manager.load(i).push_back(other_graph_ptr.load().load().memory_pool_manager.load(i).load(j) + memory_pool_len)
    
    # free node ids
    for i in range(graph_ptr.load().load().free_node_ids.load().len.load()):
        graph_ptr.load().load().free_node_ids.load().push_back(other_graph_ptr.load().load().free_node_ids.load().load(i) + num_nodes)
    
    # free data ids
    for i in range(graph_ptr.load().load().free_data_ids.load().len.load()):
        graph_ptr.load().load().free_data_ids.load().push_back(other_graph_ptr.load().load().free_data_ids.load().load(i) + memory_pool_len)
